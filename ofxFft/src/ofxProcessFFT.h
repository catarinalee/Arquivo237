...
public:
    ...
    vector <float> *getgraphLow(){return &graphLow;}
    vector <float> *getgraphMid(){return &graphMid;}
    vector <float> *getgraphHigh(){return &graphHigh;}
    vector <float> *getgraphSuperLow(){return &graphSuperLow;}
